...
<html lang="en">
  ...
  Functional but doesnt have design yet. <br>===================================================================================================================================================
<br>
<br>
<br>
...
<br>
      ...
      <h4 style="text-align: center; font-style: normal;font-size: 18px;font-family: Verdana">PERSONAL INFORMATION (Add resident page)</h4>
      <br>     
...
<center><p style="font-size: 15px;">Fill up all the required fields with asterisk**</p></center>
 <div class="clearfix"></div>
<div class="clg-offset-4" id="image-holder">
    </div>
     <div class="clearfix"></div>
<div class="form-group clg-offset-5 clm-4">
  <div class="upload">
...
<script>
  ...
  <div class="clearfix"></div>
  <div required class="form-group clm-4">
...
<br>
  ...
  <div class="form-group clm-4">
    ...
    <input type="text" maxlength="20" class="form-control" id="res_subd" name="res_subd" placeholder="Subdivision">
           ...
           <div class="form-group clm-4">
      <label for="res_purokno"> Division.*</label>
...
<br><br>
      ...
      <div class="modal-footer">
          <div class="clearfix"></div>
   <div class="r-bttn" >
       &nbsp;&nbsp; <p > <center><a href="profile.php">  <input type="submit" name="insert" id="insert" value="Save" class="btn btn-info" /> </a></center></p>
      ...
      *It keeps record but not finalize yet. it supposed to save not insert data once resident already recorded its information, this page should be auto fill. (Soon to be developed)<br>
      (End of add resident)===================================================================================================================================================
    </div>
  </div>
</div>
