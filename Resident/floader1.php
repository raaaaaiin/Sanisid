...
$getmom = mysqli_query($db, "SELECT * FROM resident_family WHERE res_ID='$largestNumber' and relType_ID = '4'");
...
$muser_id=$user_id;
	...
	If($muser_id ){
        ...
        $query=mysqli_query($db,"INSERT INTO resident_family(relation_ID,res_ID,family_res_ID,relType_ID) VALUES('$Frid','$db_res_id','$muser_id','3') ");
    echo "<script type='text/javascript'>alert('submitted successfully!');window.location = 'resident.php'</script>";
        ...
        border-left: 6px solid #2196F3;
            ...
            <p>&nbsp; <strong>Instruction!</strong> This is the finalization of add resident, just verify and check if all data provided is accurate if all is set and done finish it by clicking <strong>Next</strong></p></div>
                        ...
                        <div class="wizard">
                            ...
                            <div class="wizard__inner">
                                <div class="form__personal">
                                    ...
                                    <img style="width:100%;height:100%" src="data:image/jpeg;base64,'.base64_encode($row['res_Img'] ).'" height="200" width="200" class="img-circle img-responsive"/>  
                                                                ...
                                                                <div class="col-1">
                                                                    <div class="col-2 form-element form-element--desktop">
                                                                        ...
                                                                        <div class="form-element date--month" name="position-meta.dateOfBirthMonth">
                                                                            ...
                                                                            <input type="text" style="width:70px;" class="data-hj-whitelist" name="res_age" value="<?php echo $age;?>" id="res_age">


                                                                        </div>
                                                                        <div class="form-element date--year" name="position-meta.dateOfBirthYear">
                                                                            <label class="">Gender *</label><br>
                                                                            <select style="width:120px; required class="form-select-custom" name="res_gender">
                                ...
                                <div class="form__personal">
                                    <div class="form-section" style="padding-top: 0px;">
                                        ...
                                        <div class="form-section__content">
                                            <div class="form__form-group">
                                                <div class="form__form-row col-1">
                                                    <div class="form__form-row--avatar" style="  background-repeat: no-repeat;
                                                            background-size: fill;background-image: url('data:image/jpeg;base64,<?php echo base64_encode($M_pic)?>')">
                                                        <div class="form__form-row--avatar--overlay">
                                                    ...
                                                    <div class="form__form-row--avatar-right">
                                                        <div class="form-element col-2" name="position-firstName">
                                                            ...
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" value="<?php echo $M_fName ." ".$M_mName." ".$M_lName ;?> " name="firstName" >
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Contact Number</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" value="<?php echo $M_contact ;?> ">
                                                        </div>
                                                        <div class="form-element col-2" name="position-firstName">
                                                            <label class="">Birth date</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="firstName" value="<?php echo $M_Bday ?>">
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Religion</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" value="<?php echo $M_religion ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-section__content">
                                            <div class="form__form-group">
                                                <div class="form__form-row col-1">
                                                    <div class="form__form-row--avatar" style="  background-repeat: no-repeat;
                                                            background-size: fill;background-image: url('data:image/jpeg;base64,<?php echo base64_encode($P_pic)?>')">
                                                        <div class="form__form-row--avatar--overlay">
                                                    ...
                                                    <div class="form__form-row--avatar-right">
                                                        <div class="form-element col-2" name="position-firstName">
                                                            <label class="">Name</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" value="<?php echo $P_fName ." ".$P_mName." ".$P_lName ;?> " name="firstName" >
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Contact Number</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" value="<?php echo $P_contact ;?> ">
                                                        </div>
                                                        <div class="form-element col-2" name="position-firstName">
                                                            <label class="">Birth date</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="firstName" value="<?php echo $P_Bday ?>">
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Religion</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" value="<?php echo $P_religion ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form__buttons">
                                        <div class="form__button" style="display:flex;justify-content: flex-end;">
                                            <button type="submit" class="btn__large button--purple">
                                                <div class="spinner--hidden"></div>Next<div class="btn__arrow-right">
