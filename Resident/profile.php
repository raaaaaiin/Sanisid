...
?>
        ...
        border-left: 6px solid #2196F3;
                    ...
                    <p>&nbsp; <strong>Instruction!</strong> This page is used to assign parents to the resident just click the attach parent and it will show a list of resident, search for the parent on the residents then select it to assign it as resident's parent
                    </p></div>
                                    ...
                                    <div class="form-section" style="padding-top: 0px;">
                                        <div class="form-section__header">
                                            <h2 class="form-section__title">
                                                ...
                                                <button  style='float:right;' onclick="location.href='../accountlogout.php'" type="submit" class="btn__large button--purple">
                                                    <div class="spinner--hidden"></div>Skip Parents<div class="btn__arrow-right">
                                        ...
                                        <div class="form-section__content">
                                            <div class="form__form-group">
                                                <div class="form__form-row col-1">
                                                    <div class="form__form-row--avatar" style="background-image: url();">
                                                    ...
                                                    <div class="form__form-row--avatar-right">
                                                        <div class="form-element col-2" name="position-firstName">
                                                            ...
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="firstName" placeholder="Full Name" disabled>
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Contact Number</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" placeholder="Contact Number" disabled>
                                                        </div>
                                                        <div class="form-element col-2" name="position-firstName">
                                                            <label class="">Birth date*</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="firstName" placeholder="Birth date" disabled>
                                                        </div>
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Religion</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" placeholder="Religion" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <button onclick="location.href='resident-select-mother.php'" type="submit" class="btn__large button--purple">
                                            <div class="spinner--hidden"></div>Attach Parent<div class="btn__arrow-right">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="svg-keyboard-arrow-right" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"></path>
                                                </svg>
                                            </div>
                                        ...
                                        <div class="form-section__content">
                                            <div class="form__form-group">
                                                <div class="form__form-row col-1">
                                                    <div class="form__form-row--avatar" style="background-image: url();">
                                                        <div class="form__form-row--avatar--overlay">
                                                            <div class="form__form-row--avatar--edit">
                                                                </div>
                                                            <div class="form__form-row--avatar--remove">
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="form__form-row--avatar-right">
                                                        ...
                                                        <div class="form-element col-2" name="position-lastName">
                                                            <label class="">Contact Number</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="lastName" placeholder="Contact" disabled>
                                                        </div>
                                                        <div class="form-element col-2" name="position-firstName">
                                                            <label class="">Birth date</label>
                                                            <input type="text" tabindex="" class="data-hj-whitelist" autocomplete="off" name="firstName" placeholder="Birth date" disabled>
