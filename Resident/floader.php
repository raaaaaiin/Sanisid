...
$muser_id=$user_id;
    ...
    echo "<script type='text/javascript'>alert('submitted successfully!')</script>";
        ...
        border-left: 6px solid #2196F3;
            ...
            <p>&nbsp; <strong>Instruction!</strong> This is just a continuation, this time its time to set a Father parent to a resident click <strong>Next</strong> to continue on father selection </p></div>
