...
<div clas="wrpr" id="searcharea">
    <div class = "cnt-fld p-4">
        ...
        border-left: 6px solid #2196F3;
                    ...
                    <span style="height:100%"><h2   style="display:inline;margin:10px;padding:10px;">Barangay Clearance</h2> <input hidden type="text" id="searchtext" class="form-ctrl ml-4" name="search" placeholder="Search Resident" style="width:25% !important">
                                    <input hidden type="submit"name="searchbtn" id="searchbtn" value="Search" <button onclick="testPass();" class="sniBut sniBut-success"></button>
        ...
        ajx.onreadystatechange = function () {
            if (ajx.readyState == 4 ) {
                ...
                if(ajx.responseText ==""){
                    ...
                    document.getElementById("interchange").innerHTML ="<h1>Sorry but you dont have any certificate issued</h1>"
                }
            }
        };
        ajx.open("POST", "search.php", true);
