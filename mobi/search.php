...
left JOIN accounts a ON finance_clearance_issued.Issue_ID = a.ID where finance_clearance_issued.Res_ID = '$id' ORDER BY finance_clearance_issued.id desc
Limit 50;
";
            ...
            while($row6 = mysqli_fetch_assoc($res_conf)){
                ...
                <li  class="table-row b post-bar"style="    align-items: center;">
                     ...
                     <div class="c c-1" hidden><?php echo $row6['id'];?>id</div>
                        <div class="c c-1" hidden><?php echo $row6['LINK'];?>Link</div>
                        <div class="c c-1" hidden><?php echo $row6['DATA'];?>Data</div>
                        <div class="c c-1">Type: <?php echo $row6['TYPE'];?></div>
                        <div class="c c-1">Date: <?php echo $row6['Created_at'];?></div>
                        <div class="c c-1">Status: <?php echo $row6['status'];?></div>
                        <div class="c c-1">  
                            
                        
                        
                        <div style="display:flex;margin-top:20px"> <?php if($row6['status'] == "Approved"): ?>

   <button onclick="downloadFile('<?php echo $row6['FILE']; ?>')" style="background-color:#7bd58b; min-width:44px; font-size:14px;; border:none; outline:none; box-shadow:none;width:100%">
  <svg style="fill:#ffffff;" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
  </svg> 
</button>
...
echo $output."&resId=".$row6['Res_ID']."&created=".$row6['Created_at'];
?>'" style="background-color:#7bd58b; min-width:44px; font-size:14px; padding:10px; border:none; outline:none; box-shadow:none;width:100%">
        <svg style="fill:#ffffff;" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
        </svg> 
    </button>
    <?php endif; ?>
    <button onclick="generateQR('<?php echo $row6['FILE']; ?>')" style="background-color: #4a90e2; min-width: 44px; font-size: 14px; padding: 10px; border: none; outline: none; box-shadow: none;width:100%">
    ...
    <button onclick="deleteRecord('<?php echo  $row6['id']; ?>')" style="background-color:#fbb2b2; min-width:44px; font-size:14px; padding:10px; border:none; outline:none; box-shadow:none;width:100%">
    <svg style="fill:#ffffff;" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
    </svg> 
</button>
