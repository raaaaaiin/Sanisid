<?php
   include("connection.php");
   		...
   		$res = mysqli_query($db, "SELECT * FROM ref_category WHERE category = '$category' GROUP BY category");
   		while($row = mysqli_fetch_assoc($res))
         	{
   			...
   			$sql = "INSERT INTO ref_category(category) VALUES ('$category')" or die("Error");
