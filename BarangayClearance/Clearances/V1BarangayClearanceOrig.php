...
else {echo "Not a resident in this Barangay!";}
?>
<?php
    ...
    <script type="text/javascript">
      function genPDF() {
        html2canvas(document.getElementById('main-container')).then(function(canvas) {
                        ...
                        doc.save('BarangayClearanceFencing.pdf'); 
        ...
        <div class="c-wrapper">
          ...
          <div class="content">
            ...
            <div id="par">
              ...
              <div class="signature signline center margin120">APPLICANT'S SIGNATURE</div>
