...
$childAge = explode(",", $_GET["childAge"]);
...
">
            <div class="header tag1">
                BARANGAY CLEARANCE SOLO PARENTS
            </div>

            <div id="par" style='font-family: Arial, Helvetica, sans-serif; font-size:16px;font-weight: 300;'>
TO WHOM IT MAY CONCERN:<br><br>
                <?php
                echo "&nbsp This is to certify that <strong>$Grantedto</strong> of legal age, a natural born Filipino, is a bonafide resident of $Addresss since $since until present.
  This further certifies that he has been a SOLO PARENT to his/her children whose name and age stated hereunder since $since until present. <br>";
       
                for($i = 1; $i <= count($children); $i++) {
                    $newnum = $i-1;
                    echo "<br>$i. $children[$newnum] — $childAge[$newnum] years old";
                }

                echo "<br><br>&nbsp This certification was issued as per request of the aforesaid person for SOLO PARENT I.D. application and renewal purpose/s.";
                ?>
