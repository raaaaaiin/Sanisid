...
TO WHOM IT MAY CONCERN:<br><br>
                <?php
                echo "&nbsp This is to certify that <strong>$Name</strong> is a bonafide resident of this Barangay Antipolo and in open and continues possession of his/her business <strong>$Business</strong> located at $Address for more than $Businessage years.<br><br>&nbsp This certification is being issued upon the request of <strong>$Name</strong> for the purpose of registering his/her business permit with the Business Permit and Licensing Office (BPLO) of the City Government of Antipolo.";
                ?>
                <br><br>
