...
">
            <div class="header tag1">
                BARANGAY CLEARANCE FENCING
            </div>

            <div id="par" style='font-family: Arial, Helvetica, sans-serif; font-size:16px;font-weight: 300;'>
TO WHOM IT MAY CONCERN:<br><br>
                <?php
                echo "&nbsp Clearance is hereby granted to <strong>$surveyor</strong> who will conduct a fencing located at $location with TCT No. $tdnarpnno, Survey No. $surveynumber, PIN: $pinnumber, TDN/ARPN No. $arpn with total lot area of $area sqm. <br><br>&nbsp Clearance is being issued based on the submitted required documents for the purpose of $purpose and/or securing the Fencing permit from the City Engineer/Building Officials.";
